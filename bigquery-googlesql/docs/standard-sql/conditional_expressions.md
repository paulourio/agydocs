...
Consistent with [equality comparisons](operators.md#logical_operators) elsewhere, if both
...
coercible to a common [supertype](conversion_rules.md#supertypes); equality comparisons are
...
This expression supports specifying [collation](collation-concepts.md).

**Return Data Type**

[Supertype](conversion_rules.md#supertypes) of `result`\[, ...\] and `else_result`.
...
three-valued logic table in [Logical operators](operators.md#logical_operators).
...
[supertype](conversion_rules.md#supertypes).

To improve performance when you filter within an aggregate
function, use the `WHERE` clause in the
[aggregate function call](aggregate-function-calls.md) instead.
...
[Supertype](conversion_rules.md#supertypes) of `expr`\[, ...\].
...
must be coercible to a common [supertype](conversion_rules.md#supertypes).

**Return Data Type**

[Supertype](conversion_rules.md#supertypes) of `true_result` and `else_result`.
...
a common [supertype](conversion_rules.md#supertypes). Synonym for
`COALESCE(expr, null_result)`.

**Return Data Type**

[Supertype](conversion_rules.md#supertypes) of `expr` or `null_result`.
...
common [supertype](conversion_rules.md#supertypes), and must be comparable.

This expression supports specifying [collation](collation-concepts.md).

**Return Data Type**

[Supertype](conversion_rules.md#supertypes) of `expr` and `expr_to_match`.
