...
- [`FORMAT_DATE`](date_functions.md#format_date)
- [`FORMAT_DATETIME`](datetime_functions.md#format_datetime)
- [`FORMAT_TIME`](time_functions.md#format_time)
- [`FORMAT_TIMESTAMP`](timestamp_functions.md#format_timestamp)
- [`PARSE_DATE`](date_functions.md#parse_date)
- [`PARSE_DATETIME`](datetime_functions.md#parse_datetime)
- [`PARSE_TIME`](time_functions.md#parse_time)
- [`PARSE_TIMESTAMP`](timestamp_functions.md#parse_timestamp)
...
| `%P` | `TIME` `DATETIME` `TIMESTAMP` | When formatting, this is either am or pm. This can't be used with parsing. Instead, use %p. <br /> | `pm` |
...
The format clause can be used in some [`CAST` functions](conversion_functions.md#cast). You
...
[format model rules](#format_model_rules_date_time).
...
You can cast a [numeric type](data-types.md#numeric_types) to a string by combining the
...
[rfc 4648](https://tools.ietf.org/html/rfc4648#section-3.3). When you decode a BASE string where X is 2, 8, or 16,
