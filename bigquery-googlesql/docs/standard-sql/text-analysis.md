...
- [`SEARCH` function](search_functions.md#search)
- [`TEXT_ANALYZE` function](text-analysis-functions.md#text_analyze)
- [`CREATE SEARCH INDEX` statement](data-definition-language.md#create_search_index_statement)
...
- [Convert to lowercase (UNICODE_LOWER)](#token_filters_unicode_lower)
