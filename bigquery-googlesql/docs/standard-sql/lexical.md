...
- A table name can be a
  [fully qualified table name (table path)](data-definition-language.md#table_path)
...
[string data type](data-types.md#string_type). A bytes literal represents a
constant value of the [bytes data type](data-types.md#bytes_type).
...
[integer data type](data-types.md#integer_types).
...
[`NUMERIC` data type](data-types.md#decimal_types).
...
[`BIGNUMERIC` data type](data-types.md#decimal_types).
...
[floating-point data type](data-types.md#floating_point_types).
...
[array data type](data-types.md#array_type).
...
struct](data-types.md#constructing_a_struct) (tuple syntax, typeless struct syntax, or typed
struct syntax).
...
[struct data type](data-types.md#struct_type).
...
[`date_canonical_format`](data-types.md#canonical_format_for_date_literals),
...
[date data type](data-types.md#date_type).
...
[`time_canonical_format`](data-types.md#canonical_format_for_time_literals), a string literal that conforms to
...
[time data type](data-types.md#time_type).
...
[`datetime_canonical_format`](data-types.md#canonical_format_for_datetime_literals), a string literal that
...
[datatime data type](data-types.md#datetime_type).
...
[`timestamp_canonical_format`](data-types.md#canonical_format_for_timestamp_literals), a string literal that
...
[timestamp data type](data-types.md#timestamp_type).
...
the [offset from Coordinated Universal Time (UTC)](data-types.md#utc_offset).
...
[time zone names](data-types.md#time_zone_name).
...
[dates](data-types.md#date_type), [datetimes](data-types.md#datetime_type), or
[timestamps](data-types.md#timestamp_type). The lower or upper bound can be unbounded,
if desired.
...
[range data type](data-types.md#range_type).

### Interval literals

An interval literal represents a constant value of the
[interval data type](data-types.md#interval_type). There are two types of
interval literals:
...
single [interval-supported datetime part](data-types.md#interval_datetime_parts).
For example:
...
see [Construct an interval with a single datetime part](data-types.md#single_datetime_part_interval).
...
[datetime parts string](data-types.md#range_datetime_part_interval),
a [starting datetime part](data-types.md#interval_datetime_parts), and an
[ending datetime part](data-types.md#interval_datetime_parts).
...
see
[Construct an interval with a datetime part range](data-types.md#single_datetime_part_interval).
...
[JSON data type](data-types.md#json_type).
...
| Table names | See Notes | Dataset and table names are case-sensitive unless the [`is_case_insensitive`](data-definition-language.md#schema_option_list) option is set to `TRUE`. |
| Column names | No |   |
| Field names | No |   |
...
| String comparisons | Yes | However, string comparisons are case-insensitive in [collations](collation-concepts.md) that are case-insensitive. This behavior also applies to operations affected by collation, such as `GROUP BY` and `DISTINCT` clauses. |
...
A named query parameter is denoted using an [identifier](#identifiers)
preceded by the `@` character. Named query
parameters can't be used alongside [positional query
parameters](#positional_query_parameters).
...
alongside [named query parameters](#named_query_parameters).
