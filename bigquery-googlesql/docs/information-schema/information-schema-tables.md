...
view](information-schema-views.md) instead.
...
| `is_insertable_into` | `STRING` | `YES` or `NO` depending on whether the table supports [DML INSERT](../standard-sql/dml-syntax.md#insert_statement) statements |
...
| `ddl` | `STRING` | The [DDL statement](../standard-sql/data-definition-language.md) that can be used to recreate the table, such as `https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/data-definition-language#create_table_statement` or `https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/data-definition-language#create_view_statement` |
| `default_collation_name` | `STRING` | The name of the default [collation specification](../standard-sql/collation-concepts.md) if it exists; otherwise, `NULL`. |
