...
you need to query the `INFORMATION_SCHEMA.KEY_COLUMN_USAGE` view,
...
the permissions required to query the `INFORMATION_SCHEMA.KEY_COLUMN_USAGE` view. To see the exact permissions that are
