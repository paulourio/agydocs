...
| `option_name` | `STRING` | The name of the option. For a list of supported options, see the [schema options list](../standard-sql/data-definition-language.md#schema_option_list). The `storage_billing_model` option is only displayed for datasets that have been updated after December 1, 2022. For datasets that were last updated before that date, the storage billing model is `LOGICAL`. |
...
qualifier](information-schema-intro.md#syntax). If you do not
