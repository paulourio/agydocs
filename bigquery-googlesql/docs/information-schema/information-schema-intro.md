...
BigQuery `INFORMATION_SCHEMA` views let you retrieve metadata about
your BigQuery objects. You can query these read-only,
system-defined views to analyze resources like datasets, jobs, and access
control.

In BigQuery, you query `INFORMATION_SCHEMA` views using
GoogleSQL by specifying a scope and a view. For example, to get
metadata for tables in a dataset, you specify
...
- [`INFORMATION_SCHEMA.PARTITIONS`](information-schema-partitions.md#scope_and_syntax)
- [`INFORMATION_SCHEMA.SEARCH_INDEXES`](information-schema-indexes.md#scope_and_syntax)
- [`INFORMATION_SCHEMA.SEARCH_INDEX_COLUMNS`](information-schema-index-columns.md)
- [`INFORMATION_SCHEMA.SEARCH_INDEX_OPTIONS`](information-schema-index-options.md)
