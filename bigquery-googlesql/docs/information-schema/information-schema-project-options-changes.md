...
Queries against this view must have a [region qualifier](information-schema-intro.md#syntax).
...
> [!NOTE]
> **Note:** To learn how to extract a JSON scalar value from the `updated_options` column and convert it to a SQL STRING value such as `JSON_VALUE()`, see [JSON functions](../standard-sql/json_functions.md#categories).
