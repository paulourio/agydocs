...
Gemini Enterprise Agent Platform Gemini model to
...
For example, you can use the `AI.IF` function to identify extremely negative
product reviews:
...
The [`AI.IF`](#) and
[`AI.GENERATE_BOOL`](bigqueryml-syntax-ai-generate-bool.md)
