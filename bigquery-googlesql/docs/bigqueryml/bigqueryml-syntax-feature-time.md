...
[`ML.ENTITY_FEATURES_AT_TIME` function](bigqueryml-syntax-entity-feature-time.md)
...
- `TIME`: a `TIMESTAMP` value that specifies the point in
  ...
  [`CURRENT_TIMESTAMP` function](../standard-sql/timestamp_functions.md#current_timestamp).
