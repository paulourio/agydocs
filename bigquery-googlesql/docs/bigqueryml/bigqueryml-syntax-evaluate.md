...
- [Imported TensorFlow models](bigqueryml-syntax-create-tensorflow.md)
- [Remote models over Cloud AI services](bigqueryml-syntax-create-remote-model-service.md)
- [Remote models over embedding models](bigqueryml-syntax-create-remote-model.md)
...
- `QUERY_STATEMENT`: a GoogleSQL query that
  ...
  GoogleSQL, see
  [Query syntax](../standard-sql/query-syntax.md#sql_syntax).
...
- `HORIZON`: an `INT64` value that specifies the
  ...
  [`CREATE MODEL`](bigqueryml-syntax-create-time-series.md)
...
- `TABLE`: the name of the input table that contains the evaluation data.
  ...
  [supervised tuning](bigqueryml-syntax-create-remote-model-tuned.md#supervised_tuning),
  ...
  [`AS SELECT`](bigqueryml-syntax-create-remote-model-tuned.md#as_select).
- `QUERY_STATEMENT`: a GoogleSQL query that
  is used to generate the evaluation data. For the supported SQL syntax of
  the `QUERY_STATEMENT` clause in
  GoogleSQL, see
...
- `total_explained_variance_ratio`: a `FLOAT64` value that contains the percentage of the cumulative variance explained by all the returned principal components. For more information, see [the `ML.PRINCIPAL_COMPONENT_INFO` function](bigqueryml-syntax-principal-component-info.md).
...
- `ML.EVALUATE` doesn't support [imported TensorFlow models](bigqueryml-syntax-create-tensorflow.md) or [remote models over Cloud AI services](bigqueryml-syntax-create-remote-model-service.md).
...
When used with remote models over Agent Platform LLMs,
