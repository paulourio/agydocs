...
- `MODEL_NAME`: the name of a
  [remote model](bigqueryml-syntax-create-remote-model-service.md)
  with a [`REMOTE_SERVICE_TYPE`](bigqueryml-syntax-create-remote-model-service.md#remote_service_type) of
...
- `RECOGNITION_CONFIG`: a `STRING` value that contains a
  ...
  [`SPEECH_RECOGNIZER` option](bigqueryml-syntax-create-remote-model-service.md#speech_recognizer), you can't
