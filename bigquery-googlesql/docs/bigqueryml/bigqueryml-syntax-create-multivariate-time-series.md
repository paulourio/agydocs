# The CREATE MODEL statement for ARIMA_PLUS_XREG models
...
time series model to [forecast](https://docs.cloud.google.com/bigquery/docs/forecasting-overview)
...
[`ARIMA_PLUS` model](bigqueryml-syntax-create-time-series.md)
with linear external regressors. For more information, see [ARIMA_PLUS: Large-scale, Accurate, Automatic and Interpretable In-Database Time Series Forecasting and Anomaly Detection in Google BigQuery](https://arxiv.org/abs/2510.24452). The following diagram shows the model pipeline:

For a diagram that shows the details of the **ARIMA_PLUS Pipeline** section
in the preceding diagram, see
[Time series modeling pipeline](bigqueryml-syntax-create-time-series.md#modeling-pipeline).
...
The following examples show how to create different types of `ARIMA_PLUS_XREG`
time series models.
...
This example shows how to create a time series model while
