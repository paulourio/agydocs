...
- `struct_numerical_features`: a `STRUCT` value that contains the [numerical](../standard-sql/data-types.md#numeric_types) input features to expand. You can specify less than or equal to `10` input features. Don't specify unnamed features or duplicate features.
