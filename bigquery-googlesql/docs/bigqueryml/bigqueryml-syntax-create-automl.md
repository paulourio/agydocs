...
[AutoML classification and regression models](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tabular-data/classification-regression/overview)
...
[`ML.PREDICT` function](bigqueryml-syntax-predict.md)
...
[AutoML training options](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tabular-data/classification-regression/train-model),
including [data splitting](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tabular-data/data-splits) and
[optimization functions](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tabular-data/classification-regression/train-model#optimization-objectives).
...
[AutoML documentation](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tabular-data/classification-regression/train-model#optimization-objectives).
...
|---|---|
| `automl_regressor` | [`INT64`](../standard-sql/data-types.md#integer_types) [`NUMERIC`](../standard-sql/data-types.md#numeric_type) [`BIGNUMERIC`](../standard-sql/data-types.md#bignumeric_type) [`FLOAT64`](../standard-sql/data-types.md#floating_point_types) |
| `automl_classifier` | Any [groupable](../standard-sql/data-types.md#data_type_properties) data type |
...
[random splitting](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tabular-data/data-splits#default-data-split).
...
[Manual split](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tabular-data/data-splits#classification-manual).

Timestamp columns are used to perform a
[chronological split](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tabular-data/data-splits#classification-time).
...
[groupable](../standard-sql/data-types.md#data_type_properties)
...
|---|---|
| [`INT64`](../standard-sql/data-types.md#integer_types) [`NUMERIC`](../standard-sql/data-types.md#numeric_type) [`BIGNUMERIC`](../standard-sql/data-types.md#bignumeric_type) [`FLOAT64`](../standard-sql/data-types.md#floating_point_types) | [`NUMERIC`](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/datasets/data-types-tabular#numeric-transf) or [`TIMESTAMP`](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/datasets/data-types-tabular#timestamp) if AutoML determines that it is a UNIX timestamp |
| [`BOOL`](../standard-sql/data-types.md#boolean_type) | [`CATEGORICAL`](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/datasets/data-types-tabular#categorical-transf) |
| [`STRING`](../standard-sql/data-types.md#string_type) [`BYTES`](../standard-sql/data-types.md#bytes_type) | Either [`CATEGORICAL`](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/datasets/data-types-tabular#categorical-transf) or [`TEXT`](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/datasets/data-types-tabular#text-transf), auto-selected by AutoML. |
| [`TIMESTAMP`](../standard-sql/data-types.md#timestamp_type) [`DATETIME`](../standard-sql/data-types.md#datetime_type) [`TIME`](../standard-sql/data-types.md#time_type) [`DATE`](../standard-sql/data-types.md#date_type) | Either [`TIMESTAMP`](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/datasets/data-types-tabular#timestamp), [`CATEGORICAL`](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/datasets/data-types-tabular#categorical-transf), or [`TEXT`](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/datasets/data-types-tabular#text-transf), auto-selected by AutoML. |

To force a numeric column to be treated as categorical, use the
[`CAST` function](../standard-sql/conversion_functions.md#cast)
...
- The [default maximum number of concurrent training jobs](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/quotas) is 5. Raising the Gemini Enterprise Agent Platform quota does not modify this quota. If you receive the error `Too many AutoML training queries have been issued within
