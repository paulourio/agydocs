...
or
[`ARIMA_PLUS_XREG`](bigqueryml-syntax-create-time-series.md)
...
[custom holiday](bigqueryml-syntax-create-time-series.md#custom_holidays):
...
- Results returned by `ML.HOLIDAY_INFO` only indicate the holiday information used during model fitting. They don't necessarily indicate the detection of a holiday effect. Use [`ML.EXPLAIN_FORECAST`](bigqueryml-syntax-explain-forecast.md) instead for actual holiday effect results.
