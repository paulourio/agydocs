...
[TimesFM model](https://docs.cloud.google.com/bigquery/docs/timesfm-model). This lets you to
...
- Evaluate forecasting results from the TimesFM model using the [`AI.EVALUATE` function](bigqueryml-syntax-ai-evaluate.md).
