...
| `ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT16` `ONNX_TENSOR_ELEMENT_DATA_TYPE_BFLOAT16` `ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT` `ONNX_TENSOR_ELEMENT_DATA_TYPE_DOUBLE` | Supported | [`FLOAT64`](../standard-sql/data-types.md#floating_point_types) |
| `ONNX_TENSOR_ELEMENT_DATA_TYPE_BOOL` | Supported | [`BOOL`](../standard-sql/data-types.md#boolean_type) |
| `ONNX_TENSOR_ELEMENT_DATA_TYPE_STRING` | Supported | [`STRING`](../standard-sql/data-types.md#string_type) |
...
- You can only use imported ONNX models with the [`ML.PREDICT` function](bigqueryml-syntax-predict.md).
