...
[Agent Platform model monitoring](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/model-monitoring/overview).
...
- `ML.VALIDATE_DATA_SKEW` doesn't support the following types of models:
  ...
  - [AutoML](bigqueryml-syntax-create-automl.md)
  - [Matrix factorization](bigqueryml-syntax-create-matrix-factorization.md)
  - [`ARIMA_PLUS`](bigqueryml-syntax-create-time-series.md)
  - Remote models over [LLMs](bigqueryml-syntax-create-remote-model.md), [Cloud AI services](bigqueryml-syntax-create-remote-model-service.md), or [Gemini Enterprise Agent Platform endpoints](bigqueryml-syntax-create-remote-model-https.md)
  - Imported [Open Neural Network Exchange (ONNX)](bigqueryml-syntax-create-onnx.md), [TensorFlow](bigqueryml-syntax-create-tensorflow.md), [TensorFlow Lite](bigqueryml-syntax-create-tflite.md), or [XGBoost](bigqueryml-syntax-create-xgboost.md) models
- `ML.VALIDATE_DATA_SKEW` doesn't support models created before March 28, 2024,
  or models that use the
  [`WARM START` option](bigqueryml-syntax-create.md#warm_start). To enable use of
  `ML.VALIDATE_DATA_SKEW`, retrain the model by running the
  [`CREATE OR REPLACE model` statement](bigqueryml-syntax-create.md#create_or_replace_model).
