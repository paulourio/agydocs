...
[Gemini Enterprise Agent Platform](https://docs.cloud.google.com/gemini-enterprise-agent-platform/overview) by using SQL.
...
- [`BOOL`](../standard-sql/data-types.md#boolean_type)
- [`INT64`](../standard-sql/data-types.md#integer_types)
- [`FLOAT64`](../standard-sql/data-types.md#floating_point_types)
- [`NUMERIC`](../standard-sql/data-types.md#decimal_types)
- [`BIGNUMERIC`](../standard-sql/data-types.md#decimal_types)
- [`STRING`](../standard-sql/data-types.md#string_type)
- An [`ARRAY`](../standard-sql/data-types.md#array_type) of any of the aforementioned types.
...
[Create a shared public endpoint](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/predictions/create-public-endpoint#create_a_shared_public_endpoint).
