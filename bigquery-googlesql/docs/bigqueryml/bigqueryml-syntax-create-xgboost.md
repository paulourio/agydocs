...
The output data type must be [`FLOAT64`](../standard-sql/data-types.md#floating_point_types).
...
- You can only use XGBoost models with the [`ML.PREDICT`](bigqueryml-syntax-predict.md) and [`ML.FEATURE_IMPORTANCE`](bigqueryml-syntax-importance.md) functions.
...
- BigQuery XGBoost models only support [numeric types](../standard-sql/data-types.md#numeric_types) as input data types and [`FLOAT64`](../standard-sql/data-types.md#floating_point_types) as the output data type.
