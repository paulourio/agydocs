...
You can use a
[`CREATE MODEL` statement](bigqueryml-syntax-create-contribution-analysis.md)
...
[summable metrics](bigqueryml-syntax-create-contribution-analysis.md#use_a_summable_metric),
...
`ML.GET_INSIGHTS` returns the following output columns for contribution
analysis models that use
[summable ratio metrics](bigqueryml-syntax-create-contribution-analysis.md#use_a_summable_ratio_metric), in
...
- `metric_test`: a numeric value that contains the ratio between the
  ...
  [`CONTRIBUTION_METRIC` option](bigqueryml-syntax-create-contribution-analysis.md#contribution_metric) of the
