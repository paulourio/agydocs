...
- [Linear and logistic regression models](bigqueryml-syntax-create-glm.md)
- [Boosted tree models](bigqueryml-syntax-create-boosted-tree.md)
- [Random forest models](bigqueryml-syntax-create-random-forest.md)
- [Deep neural network (DNN) models](bigqueryml-syntax-create-dnn-models.md)
- [Wide-and-deep models](bigqueryml-syntax-create-wnd-models.md)
...
- Imported models:
  - [ONNX models](bigqueryml-syntax-create-onnx.md)
  - [TensorFlow models](bigqueryml-syntax-create-tensorflow.md)
  - [TensorFlow Lite models](bigqueryml-syntax-create-tflite.md)
  - [XGBoost models](bigqueryml-syntax-create-xgboost.md)
- [Agent Platform hosted models](bigqueryml-syntax-create-remote-model-https.md)

For PCA and autoencoder models, you can use the
[`AI.GENERATE_EMBEDDING` function](bigqueryml-syntax-ai-generate-embedding.md) as an alternative to the `ML.PREDICT`
function.
...
- `TABLE`: The name of the input table that contains the
  ...
  BigQuery [implicit coercion rules](../standard-sql/conversion_rules.md#coercion).

  For TensorFlow Lite, Open Neural Network Exchange (ONNX), and
  XGBoost models, the input must be
  [convertible](../standard-sql/conversion_rules.md) to
...
- `QUERY_STATEMENT`: The GoogleSQL query that
  ...
  [implicit coercion rules](../standard-sql/conversion_rules.md#coercion).
  ...
  If you used the
  [`TRANSFORM` clause](bigqueryml-syntax-create.md#transform)
  ...
  [`ML.DECODE_IMAGE` function](bigqueryml-syntax-decode-image.md)
  ...
  [Predict an outcome from image data with an imported TensorFlow model](#tensorflow-unstructured).
...
- `nearest_centroids_distance`: an `ARRAY<STRUCT>` value that contains the distances to the nearest `k` clusters, where `k` is equal to the lesser of `num_clusters` or `5`. If the model was created with the [`standardize_features` option](bigqueryml-syntax-create.md#model_option_list) set to `TRUE`, then the model computes these distances using standardized features; otherwise, it computes these distances using non-standardized features.
...
[the `CREATE MODEL` statement for TensorFlow models](bigqueryml-syntax-create-tensorflow.md)
