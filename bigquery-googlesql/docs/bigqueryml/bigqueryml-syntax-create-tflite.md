...
|---|---|---|
| `UINT8, UINT16, UINT32, UINT64, INT8, INT16, INT32, INT64` | Supported | [`INT64`](../standard-sql/data-types.md#integer_types) |
| `FLOAT16, FLOAT32, FLOAT64` | Supported | [`FLOAT64`](../standard-sql/data-types.md#floating_point_types) |
| `COMPLEX64, COMPLEX128` | Unsupported | N/a |
| `BOOL` | Supported | [`BOOL`](../standard-sql/data-types.md#boolean_type) |
| `STRING` | Supported | [`STRING`](../standard-sql/data-types.md#string_type) |
...
- You can only use TensorFlow Lite models with the [`ML.PREDICT` function](bigqueryml-syntax-predict.md).
