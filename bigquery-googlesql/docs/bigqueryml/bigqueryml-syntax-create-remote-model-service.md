...
- For Cloud Natural Language API models, use [`ML.UNDERSTAND_TEXT`](bigqueryml-syntax-understand-text.md)
- For Cloud Translation API models, use [`ML.TRANSLATE`](bigqueryml-syntax-translate.md)
- For Cloud Vision API models, use [`ML.ANNOTATE_IMAGE`](bigqueryml-syntax-annotate-image.md)
- For Document AI API models, use [`ML.PROCESS_DOCUMENT`](bigqueryml-syntax-process-document.md) ([preview](https://cloud.google.com/products#product-launch-stages))
- For Speech-to-Text API models, use [`ML.TRANSCRIBE`](bigqueryml-syntax-transcribe.md) ([preview](https://cloud.google.com/products#product-launch-stages))
...
[`recognition_config` argument](bigqueryml-syntax-transcribe.md#arguments)
