...
[numerical](../standard-sql/data-types.md#numeric_types)
...
such as
[`ML.BUCKETIZE`](bigqueryml-syntax-bucketize.md).
...
[`apriori_support` value](bigqueryml-syntax-get-insights.md#output)
...
- Learn how to call the [`ML.GET_INSIGHTS` function](bigqueryml-syntax-get-insights.md) to get insights from your contribution analysis model.
