...
generation models deployed to [Gemini Enterprise Agent Platform](https://docs.cloud.google.com/gemini-enterprise-agent-platform/overview). When you
...
[`AI.GENERATE_EMBEDDING`](bigqueryml-syntax-ai-generate-embedding.md)
or
...
You must grant the
[Agent Platform User role](https://docs.cloud.google.com/iam/docs/roles-permissions/aiplatform#aiplatform.user)
...
The model ID for a
[supported Hugging Face model](#hugging-face-models),
...
[supported Agent Platform Model Garden model](#model-garden-models),
...
information, see
[Compute Engine reservation affinity](#reservation-affinity).
...
- Running the [`CREATE MODEL` statement](#).
- Running the [`ALTER MODEL` statement](bigqueryml-syntax-alter-model.md#deploy_model) with the `DEPLOY_MODEL` argument set to `TRUE`.
- Sending an inference request to the model endpoint. For example, by running the [`AI.GENERATE_EMBEDDING`](bigqueryml-syntax-ai-generate-embedding.md) or [`AI.GENERATE_TEXT`](bigqueryml-syntax-ai-generate-text.md) function.
...
[interval literal](../standard-sql/lexical.md#interval_literals)
...
use the [`ALTER MODEL` statement](bigqueryml-syntax-alter-model.md#endpoint_idle_ttl).
...
[Agent Platform Model Garden](https://docs.cloud.google.com/vertex-ai/generative-ai/docs/model-garden/explore-models)
or
...
see
[Use reservations with inference](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/predictions/use-reservations).
...
[`ALTER MODEL` statement](bigqueryml-syntax-alter-model.md).
...
[undeploy the model](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/predictions/undeploy-model).
