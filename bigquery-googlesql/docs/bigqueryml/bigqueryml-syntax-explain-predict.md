...
[`ML.PREDICT`](bigqueryml-syntax-predict.md).
...
- `APPROX_FEATURE_CONTRIB`: a `BOOL` value that indicates
  ...
  [boosted tree](bigqueryml-syntax-create-boosted-tree.md)
  and
  [random forest](bigqueryml-syntax-create-random-forest.md)
  models.
...
- `approximation_error`:
  ...
  - Exact attribution methods like Tree SHAP are defined as follows:
    ...
    - [Linear \& logistic regression](bigqueryml-syntax-create-glm.md)
    - [Boosted tree](bigqueryml-syntax-create-boosted-tree.md)
    - [Random forest](bigqueryml-syntax-create-random-forest.md)
