...
Cancels a user-initiated [alteration of a search index](../standard-sql/data-definition-language.md#alter_search_index_statement) or
[rebuild of a vector index](../standard-sql/data-definition-language.md#alter_vector_index_rebuild_statement).
...
For a selective refresh to work correctly, the Cloud Storage path
parameters must include either a specific path or a wildcard. For more
information, see [Wildcard support for Cloud Storage URIs](https://docs.cloud.google.com/bigquery/docs/external-data-cloud-storage#wildcard-support).
...
[`GRAPH_EXPAND` TVF](../graph/graph-sql-queries.md#graph_expand)
on `graph_name`.
