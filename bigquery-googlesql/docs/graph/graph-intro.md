...
represents a modifier to statements. See the [statement list](graph-query-statements.md#language_list) for a complete list.
...
list](graph-query-statements.md#language_list). It always ends with a [`RETURN` statement](graph-query-statements.md#gql_return).
...
For more information, see the syntax for the [GQL set operation](graph-query-statements.md#gql_set).
