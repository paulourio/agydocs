...
```bash
    gcloud container clusters update NAME
        (--anonymous-authentication-config=ANONYMOUS_AUTHENTICATION_CONFIG
          ...
          | --enable-fleet | --enable-fqdn-network-policy
       ...
       At most one of these can be specified:
         ...
         Examples:
           ...
           --add-maintenance-exclusion-end=TIME_STAMP
              ...
              time. See [`gcloud topic datetimes`](../topic/topic-datetimes.md) for information on time
              formats.
         ...
         For a daily window from 22:00 - 04:00 UTC:
           ...
           --maintenance-window-end=TIME_STAMP
              ...
              removed. See [`gcloud topic datetimes`](../topic/topic-datetimes.md) for information on time
              formats.
           ...
           --maintenance-window-start=TIME_STAMP
              ...
              [`gcloud topic datetimes`](../topic/topic-datetimes.md) for information on time formats.
