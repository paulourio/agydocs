...
## NAME
    ...
    gcloud compute instance-groups managed create - create a Compute Engine
...
## OPTIONAL FLAGS
     ...
     --initial-delay=INITIAL_DELAY
        ...
        The default value is 0. See [`gcloud topic datetimes`](../topic/topic-datetimes.md) for information on
        duration formats.
