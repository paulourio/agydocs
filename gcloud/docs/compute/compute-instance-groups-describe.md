...
## NAME
    ...
    gcloud compute instance-groups describe - display detailed information
        about an instance group
...
## FLAGS
     ...
     At most one of these can be specified:
       ...
       --region=REGION
          Region of the instance group to describe. If not specified, you might
       ...
       --zone=ZONE
          Zone of the instance group to describe. If not specified, you might
