# [`gcloud topic configurations`](topic-configurations.md)

## NAME

    [`gcloud topic configurations`](topic-configurations.md) - supplementary help for named configurations
...
## AVAILABLE PROPERTIES
     ...
     core
         ...
         default_format
            ...
            more details run [`gcloud topic formats`](topic-formats.md). Run $ gcloud config set
         ...
         format
            ...
            text. For more details run [`gcloud topic formats`](topic-formats.md). Run $ gcloud
     ...
     context_aware
         use_client_certificate
            ...
            will not be validated. Run [`gcloud topic client-certificate`](topic-client-certificate.md) for list
