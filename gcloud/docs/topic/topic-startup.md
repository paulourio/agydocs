# [`gcloud topic startup`](topic-startup.md)

## NAME

    [`gcloud topic startup`](topic-startup.md) - supplementary help for gcloud startup options
...
Choosing a Python Interpreter
    ...
    3.9-3.13. Certain Windows and Linux installs include a bundled Python
...
### Linux-based installs include a bundled Python installation on x86_64
    ...
    gsutil versions 5.0 and later support Python 3.9-3.11. To use a different
...
### CLOUDSDK_GSUTIL_PYTHON environment variable to the interpreter that you
    ...
    bq versions 2.0.99 and later support Python 3.9-3.13. To use a different
...
### Your active configuration can also be set via the environment variable
    ...
    For more information, see [`gcloud topic configurations`](topic-configurations.md).