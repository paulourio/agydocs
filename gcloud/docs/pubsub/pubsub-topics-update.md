       ...
       default value.
         ...
         This must be specified.
           ...
           --schema=SCHEMA
              ...
              o provide the argument --schema on the command line.
           ...
           --schema-project=SCHEMA_PROJECT
              ...
              To set the project attribute:
              o provide the argument --schema on the command line with a
                fully specified name;
              o provide the argument --schema-project on the command line;
