       ...
       default value.
         ...
         attributes of this resource.
           ...
           --dead-letter-topic=DEAD_LETTER_TOPIC
              ...
              o provide the argument --dead-letter-topic on the command line.
           ...
           --dead-letter-topic-project=DEAD_LETTER_TOPIC_PROJECT
              ...
              o provide the argument --dead-letter-topic-project on the
                command line;
              o provide the argument --project on the command line;
              o set the property core/project.
     ...
     At most one of these can be specified:
       ...
       --clear-labels
          ...
          For example, to remove all labels:
              ...
              $ gcloud pubsub subscriptions update --clear-labels
